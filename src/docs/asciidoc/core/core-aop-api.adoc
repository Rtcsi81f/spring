...
The `man` bean definition shown earlier can be used in place of a `Person` implementation, as
follows:
...
.Kotlin
----
	val man = factory.getBean("man") as Person;
----
...
----
	<bean id="personUser" class="com.mycompany.PersonUser">
		<property name="man"><ref bean="man"/></property>
	</bean>
----

The `PersonUser` class in this example exposes a property of type `Person`. As far as
it is concerned, the AOP proxy can be used transparently in place of a "`real`" man
...
----
	...
	<bean id="man" class="org.springframework.aop.framework.ProxyFactoryBean">
		<property name="proxyInterfaces" value="com.mycompany.Person"/>
