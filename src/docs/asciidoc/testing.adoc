...
----
	mockMvc.perform(post("/persons"))
		.andExpect(status().isOk())
		.andExpect(model().attributeHasErrors("man"));
----
...
----
	...
	mockMvc.perform(get("/handle").accept(MediaType.APPLICATION_XML))
		.andExpect(xpath("/man/ns:link[@rel='self']/@href", ns).string("http://localhost:8080/people"));
----
...
----
	...
	mockMvc.get("/handle") {
		...
		xpath("/man/ns:link[@rel='self']/@href", ns) {
