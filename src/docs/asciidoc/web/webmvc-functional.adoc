...
----
Person man = ...
ServerResponse.ok().contentType(MediaType.APPLICATION_JSON).body(man);
----
[source,kotlin,role="secondary"]
.Kotlin
----
...
public class PersonHandler {
	...
	public ServerResponse createPerson(ServerRequest request) throws Exception { // <2>
		Person man = request.body(Person.class);
	...
	public ServerResponse getPerson(ServerRequest request) { // <3>
		...
		Person man = repository.getPerson(personId);
		if (man != null) {
			return ok().contentType(APPLICATION_JSON).body(man))
		}
		else {
