...
abstract class AnnotationsScanner {
     ...
     * <p>
     * 这里根据 AnnotatedElement 类型的不同，又区分 Method、Class 以及其他 AnnotatedElement ，这三种对象会有不同的扫描方式。
     * AnnotationScanner 对这三者的扫描方式大同小异，基本都是没层级结构就直接返回，有层级结构就通过反射遍历按深度优先扫描层级结构。
     *
     * @param context
     * @param source
