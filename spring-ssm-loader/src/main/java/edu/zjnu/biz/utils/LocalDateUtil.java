...
public class LocalDateUtil {
    ...
    public static String getLocalDateStr() {
        return format(LocalDateTime.from(LocalDate.now()), DATE_PATTERN);
    }
    ...
    public static String getLocalTimeStr() {
        return format(LocalDateTime.from(LocalTime.now()), TIME_PATTERN);
    }
    ...
    public static String getDayOfWeekStr() {
        return format(LocalDateTime.from(LocalDate.now()), "E");
    }
     ...
     * @return String 日期时间字符串，例如 2015-08-11 09:51:53
     */
    public static String format(LocalDateTime temporal, String pattern) {
