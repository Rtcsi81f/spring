...
/**
 *  参见 loader 模块的 spring-factory 案例,
 *  @see edu.zjnu.xml.factory.FactoryMain
 *
 *  可以看到，aop 就是基于 FactoryBean s实现的，运用了代理模式的思想
 *
 *  猜测 ProxyFactoryBean 应该包含了创建Aop 应用的最底层方法
 *  所以，考虑将 ProxyFactoryBean 作为入口展开研究 Aop 实现
 *
 */
