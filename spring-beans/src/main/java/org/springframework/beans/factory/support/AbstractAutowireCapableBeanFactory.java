...
//			重点方法： createBeanInstance 中生成了 BeanDefinition
        ...
        // Initialize the bean instance. 这里是对 bean 的初始化，依赖注入往往在这里发生，这个 exposedObject 对象在初始化处理完了以后
        // 会作为依赖注入完成之后的bean返回
    ...
    protected BeanWrapper createBeanInstance(String beanName, RootBeanDefinition mbd, @Nullable Object[] args) {
        // Make sure bean class is actually resolved at this point. // 喜爱那确认要创建的 bean实例 的类是可以实例化的
...
//                使用 cglib 对 bean 进行实例化(另外一种方法是bBeanUtils 中的JDK动态代理)
//                cglib 是一个常用的字节码生成器的类库，它提供了一系列的 api 来提供 java 的字节码生成和转换功能。
//                AOP 也是使用了 cglib 来对提供 Java 的字节码生成和转换的功能
